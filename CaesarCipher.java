...
public class CaesarCipher {
  ...
  /*
   * Function: Cipher Pre-condition: Takes in a string and an integer (key). Post-condition: Outputs
   * a string that is the encoded/decoded version of the original string.
   */
