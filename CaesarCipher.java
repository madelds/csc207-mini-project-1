/**
 * Encodes or decodes a string given by 
 * the user according to the Caesar Cipher.
 * @author Madel Sibal
 * September 7, 2023
 */
...
public class CaesarCipher {
     ...
     * Post-condition: Prints the encoded version of the string for each
    ...
    /* Function: Decode
     * Pre-condition: Takes in a string.
     * Post-condition: Prints the decoded version of the string for each 
     * letter of the alphabet.
     */
    ...
    /* Function: Cipher
     * Pre-condition: Takes in a string and an integer (key).
