...
public class VigenereCipher {
  ...
  /*
   * Function: isValidInput Pre-condition: Takes in a string. Post-condition: Returns True if all
   * the characters in the string are lowercase letters or if the string is empty. Otherwise,
   * returns False.
   */
  ...
  /*
   * Function: cipher Pre-condition: Takes in two strings (a word and a key) and an integer
   * representing the instruction (1 = encode, -1 = decode). Post-condition: Outputs a string that
   * is the encoded/decoded version of the original string.
   */
  private static String cipher(String word, String key, int instruction) {
    ...
    /*
     * Calculates the letter of the keyword by which each individual letter of the original word
     * should shift by.
     */
    for (int i = 0; i < wordLength; i++) {
      ...
      /*
       * Appends each character to newWord until the new word is formed at the end of the for loop
       */
  ...
  /*
   * Function: Encode Pre-condition: Takes in two strings (a word and a key). Post-condition:
   * Outputs a string that is the encoded version of the original string.
   */
  ...
  /*
   * Function: Decode Pre-condition: Takes in two strings (a word and a key). Post-condition:
   * Outputs a string that is the decoded version of the original string.
   */
